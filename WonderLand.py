...
class Customer:
    ...
    def book_ticket(self):
    	self.__ticket.calculate_amount(self.__list_of_games)
    	if self.__ticket.get_ticket_amount()!=0:
    ...
    def get_ticket(self):
    	return self.__ticket.get_ticket_amount()
...
cust1.play_game()
cust1.update_food_coupon()
cust1.book_ticket()
print(cust1.get_name())
print(cust1.get_list_of_games())
print(cust1.get_ticket())
print(cust1.get_points_earned())
print(cust1.get_food_coupon())
